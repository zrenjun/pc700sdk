...
Java_com_Carewell_ecg700_ParseData_newShortFilter(JNIEnv *env, jobject thiz, jshortArray inShorts) {
...
//Java_com_viatom_baselib_filter_FilterUtil_offlineFilter(JNIEnv *env, jobject thiz, jdoubleArray doubles) {
//
//	double *doubleArray;
